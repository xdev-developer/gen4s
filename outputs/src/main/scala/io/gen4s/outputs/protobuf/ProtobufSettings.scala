...
import fs2.kafka.vulcan.{SchemaRegistryClient, SchemaRegistryClientSettings}
...
object ProtobufSettings {
  ...
  private[this] final case class ProtobufSettingsImpl[F[_], JavaProto <: Message](
    ...
    val createProtobufSerializerWith: (
      F[SchemaRegistryClient],
      Boolean,
      Map[String, String]
    ...
    override def withCreateProtobufDeserializer(
      createProtobufDeserializerWith: (
        F[SchemaRegistryClient],
        Boolean,
        Map[String, String]
      ) => F[KafkaProtobufDeserializer[JavaProto]]
    ...
    override def withCreateProtobufSerializer(
      createProtobufSerializerWith: (
        F[SchemaRegistryClient],
        Boolean,
        Map[String, String]
      ) => F[KafkaProtobufSerializer[JavaProto]]
